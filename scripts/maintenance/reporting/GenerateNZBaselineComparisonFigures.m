...
% Template-based script aligned with GenerateEESimulationResultsFigures.m.
...
if ~isfile(baselineCsv)
    error('GenerateNZBaselineComparisonFigures:missingCsv', ...
...
if isempty(commonYears)
    error('GenerateNZBaselineComparisonFigures:noYears', ...
...
function require_vars(tbl, vars, name)
    ...
    if ~isempty(missing)
        error('GenerateNZBaselineComparisonFigures:missingVars', ...
...
function save_dual(fig, outDir, stem)
    ...
    try
        ...
        try
            ...
            warning('GenerateNZBaselineComparisonFigures:svgExportFailed', ...
    ...
    try
        ...
        try
            ...
            warning('GenerateNZBaselineComparisonFigures:pngExportFailed', ...
