...
phiKPV0_p = 0.03;//0.03;
phiQPV0_p = 0.02;//0.02;
phiKPE_p = 0.2;//0.25 works makes investment adjustment cost high enough
rhophiK_p = 0.75;
gamPEdel_p = 0;
sigmaL_p = 0.5;
sigmaC_p = 1;
sigmaU_p = 2;   % utilization curvature (sigmaU > rKSS/delta ensures delta_eff >= 0 at u_K=0)
etaKS_p = 10;   % capital goods supply elasticity; etaKS → ∞ gives P_K = P (no friction)
rhoA_p = 0.9;
rhos_p = 0.5;
etaF_p = 1.1; 
etaM_p = 0.95;
...
@# for sec in 1:Sectors
    ...
    @# for subsec in Subsecstart[sec]:Subsecend[sec]
        ...
        @# for reg in 1:Regions
            ...
            targetIY0_@{subsec}_@{reg}_p = 0.05;
