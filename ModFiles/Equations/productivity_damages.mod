...
@# for reg in 1:Regions
    @# for sec in 1:Sectors  
        ...
        @# for subsec in Subsecstart[sec]:Subsecend[sec]
            ...
            # IDamRefRaw_@{reg}_@{subsec} = 0.01*(1-phiG_effDam_@{reg}_@{subsec})*delta_@{subsec}_@{reg}_p*K0_@{subsec}_@{reg}_p;
            ...
            # rhsExoSubsec_8_raw_@{reg}_@{subsec} =  exo_D_K_@{subsec}_@{reg} * K0_@{subsec}_@{reg}_p;
            ...
            @# if lCapPrice == 0
                ...
                @# if lCapGoodsSecPrice == 1
                    # rhsExoSubsec_PINV_@{reg}_@{subsec} = P_Q_@{CapGoodsSubsec}_@{reg} * exp(exo_I_@{subsec}_@{reg});
                @# else
                    # rhsExoSubsec_PINV_@{reg}_@{subsec} = P_@{subsec}_@{reg} * exp(exo_P_K_@{subsec}_@{reg});
                @# endif

                [name = 'Price of investment goods @{subsec} @{reg}']
                (P_INV_@{subsec}_@{reg} + 1) / (rhsExoSubsec_PINV_@{reg}_@{subsec} + 1) = 1;
            @# endif

            # lhsExoSubsec_phiK_@{reg}_@{subsec} = phiK_@{subsec}_@{reg} + phiG_p * (exo_I_@{subsec}_@{reg}+exo_P_K_@{subsec}_@{reg});
            # rhsExoSubsec_phiK_@{reg}_@{subsec} = phiK_@{subsec}_@{reg}_p * exp(exo_phiK_@{subsec}_@{reg});//rhophiK_p*phiK_@{subsec}_@{reg}(-1) + (1-rhophiK_p)*(min(1000,phiK_@{subsec}_@{reg}_p * exp(exo_phiK_@{subsec}_@{reg}) * exp(0*phiKPE_p*(steady_state(PE_@{reg})-PE0_@{reg}_p)*((@{subsec} == @{SubsecFossil})))));
 
            [name = 'investment adjustment cost curvature']
            (lhsExoSubsec_phiK_@{reg}_@{subsec}+1) / (rhsExoSubsec_phiK_@{reg}_@{subsec}+1) = 1;
            ...
            (lhsExoSubsec_mu_@{reg}_@{subsec}+1) / (rhsExoSubsec_mu_@{reg}_@{subsec}+1) = 1;
            ...
            (lhsDemandSubsec_AD_@{reg}_@{subsec}+1) / (rhsDemandSubsec_AD_@{reg}_@{subsec}+1) = 1;
