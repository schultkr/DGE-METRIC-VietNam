...
@# for reg in 1:Regions
    @# for sec in 1:Sectors                                
        @# for subsec in Subsecstart[sec]:Subsecend[sec]
            ...
            (lhsSupplySubsec_Plog_@{subsec}_@{reg}+1) / (rhsSupplySubsec_Plog_@{subsec}_@{reg}+1) = 1;
            ...
            (lhsSupplySubsec_1_@{subsec}_@{reg}+1) / (rhsSupplySubsec_1_@{subsec}_@{reg}+1) = 1;
            ...
            @# for secm in 1:Sectors
                ...
                (lhsSupplySubsecSec_1_@{subsec}_@{reg}_@{secm}+1) / (rhsSupplySubsecSec_1_@{subsec}_@{reg}_@{secm}+1) = 1;
                ...
                (lhsSupplySubsecSec_3_@{subsec}_@{reg}_@{secm}+1) / (rhsSupplySubsecSec_3_@{subsec}_@{reg}_@{secm}+1) = 1;
            @# endfor
            ...
            [name = 'regional sector demand for intermediates']
            (lhsSupplySubsec_3_@{subsec}_@{reg}+1) / (rhsSupplySubsec_3_@{subsec}_@{reg}+1) = 1;
            ...
            (lhsSupplySubsec_4_@{subsec}_@{reg}+1) / (rhsSupplySubsec_4_@{subsec}_@{reg}+1) = 1;
            ...
            (lhsSupplySubsec_Kexp_@{subsec}_@{reg}+1)/(rhsSupplySubsec_Kexp_@{subsec}_@{reg}+1) = 1;
            ...
            (lhsSupplySubsec_Keff_@{subsec}_@{reg}+1)/(rhsSupplySubsec_Keff_@{subsec}_@{reg}+1) = 1;
            ...
            (lhsSupplySubsec_Ieff_@{subsec}_@{reg}+1)/(rhsSupplySubsec_Ieff_@{subsec}_@{reg}+1) = 1;
            ...
            [name = 'Firms FOC capital']
            (lhsSupplySubsec_5_@{subsec}_@{reg}+1) / (rhsSupplySubsec_5_@{subsec}_@{reg}+1) = 1;
            ...
            (lhsSupplySubsec_6_@{subsec}_@{reg}+1) / (rhsSupplySubsec_6_@{subsec}_@{reg}+1) = 1;
            ...
            (lhsSupplySubsec_7_@{subsec}_@{reg}+1) / (rhsSupplySubsec_7_@{subsec}_@{reg}+1) = 1;
            ...
            (lhsSupplySubsec_9_@{subsec}_@{reg}+1) / (rhsSupplySubsec_9_@{subsec}_@{reg}+1) = 1;
            ...
            ;
            [name = 'sector region specific output']
            (lhsSupplySubsec_10_@{subsec}_@{reg}+1) / (rhsSupplySubsec_10_@{subsec}_@{reg}+1) = 1;
            ...
            (lhsEmissionsSubsecSec_1_@{subsec}_@{reg}+1) / (rhsEmissionsSubsecSec_1_@{subsec}_@{reg}+1) = 1;
