...
@# for reg in 1:Regions
    ...
    @# for sec in 1:Sectors
        @# for subsec in Subsecstart[sec]:Subsecend[sec]
            + (I_G_@{subsec}_@{reg} * P_K_@{subsec}_@{reg} - r_G_@{subsec}_@{reg} * P_K_@{subsec}_@{reg} * K_G_@{subsec}_@{reg}(-1))
        @# endfor
    @# endfor
    ;
    ...
    @# for sec in 1:Sectors
        @# for subsec in Subsecstart[sec]:Subsecend[sec]
            ...
            //@# else
            //    # rhsExoSubsec_12_@{reg}_@{subsec} =  phiG_@{subsec}_@{reg}_p * I0_G_@{subsec}_@{reg} + (exo_KTargetB_@{subsec}_@{reg}) * (exo_KTarget_@{subsec}_@{reg} * Y/P_K_@{subsec}_@{reg});
            //@# endif
