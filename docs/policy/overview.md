...
1. **Energy efficiency (demand-side):** How much energy industry and services need per unit of output. Improving efficiency means the same GDP requires less fossil and renewable energy, freeing resources for consumption and other investment.

2. **Renewable investment and grid integration:** How quickly the renewable capital stock builds up and at what cost — including the upfront capital expenditure for grid balancing and storage that underpins a higher renewable share.
...
1. [Running the model](../reference/running.md) — software requirements, quick start, common tasks
2. [Model equations](../reference/model.md) — full technical documentation with equations
3. [Calibration](../reference/calibration.md) — how baseline parameters are estimated
4. [Scenario design](../reference/scenario.md) — how shocks are constructed and loaded

### I want to understand a specific scenario family

- Energy efficiency scenarios: [EE scenario design](../scenario_notes/ee_scenario_design.md)
- Green finance scenarios: [Finance instruments feasibility](../scenario_notes/finance_instruments_comments_feasibility.md)
- Grid investment scenarios (proposed, not yet implemented): [Grid investment scenario design](../implementation_plans/grid_investment_scenario_design.md)
