...
| `EE_Directive10` | EU Directive 10 equivalent (high) | Yes |
| `EE_PDP8_PV_BESS_NoBESS` | PDP8 efficiency targets | No (BESS channels reset to baseline) |
| `EE_Directive10_NoBESS` | EU Directive 10 equivalent | No |
...
The Directive 10 scenario uses higher saving percentages calibrated to EU-equivalent targets, resulting in a steeper AI path and larger investment cost in the early period.
...
- [EE scenario design (implementation)](ee_scenario_design.md) — variable mapping, BESS channel construction
- [EE scenario results data](ee_simulation_scenarios_results.md) — full tables and figure references
- [EE workbook comparison](ee_scenarios_workbook_comparison.md) — workbook structure and named ranges
