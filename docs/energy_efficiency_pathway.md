...
<figure style="text-align:center; margin: 1.2rem 0;">
  ...
  <img src="figures/Efficiency/EnergyIntensity.png" alt="Energy intensity pathways" style="width:88%; max-width:980px; border-radius:6px;" />
</figure>
...
<figure style="text-align:center; margin: 1.2rem 0;">
  ...
  <img src="figures/Efficiency/FinalEnergyDemand.png" alt="Final energy demand pathways" style="width:88%; max-width:980px; border-radius:6px;" />
</figure>
...
<figure style="text-align:center; margin: 1.2rem 0;">
  ...
  <img src="figures/Efficiency/GDP.png" alt="GDP effects" style="width:88%; max-width:980px; border-radius:6px;" />
</figure>

<figure style="text-align:center; margin: 1.2rem 0;">
  <figcaption><em>Figure 4. Investment.</em></figcaption>
  <img src="figures/Efficiency/Investment.png" alt="Investment effects" style="width:88%; max-width:980px; border-radius:6px;" />
</figure>

<figure style="text-align:center; margin: 1.2rem 0;">
  <figcaption><em>Figure 5. Consumption.</em></figcaption>
  <img src="figures/Efficiency/Consumption.png" alt="Consumption effects" style="width:88%; max-width:980px; border-radius:6px;" />
</figure>

<figure style="text-align:center; margin: 1.2rem 0;">
  <figcaption><em>Figure 6. Government expenditure.</em></figcaption>
  <img src="figures/Efficiency/Government.png" alt="Government effects" style="width:88%; max-width:980px; border-radius:6px;" />
</figure>

<figure style="text-align:center; margin: 1.2rem 0;">
  <figcaption><em>Figure 7. Trade balance.</em></figcaption>
  <img src="figures/Efficiency/TradeBalance.png" alt="Trade balance effects" style="width:88%; max-width:980px; border-radius:6px;" />
</figure>
...
<figure style="text-align:center; margin: 1.2rem 0;">
  ...
  <img src="figures/Efficiency/EnergyPrices.png" alt="Energy price effects" style="width:88%; max-width:980px; border-radius:6px;" />
</figure>

<figure style="text-align:center; margin: 1.2rem 0;">
  <figcaption><em>Figure 9. Energy expenditure.</em></figcaption>
  <img src="figures/Efficiency/EnergyExpenditure.png" alt="Energy expenditure effects" style="width:88%; max-width:980px; border-radius:6px;" />
</figure>
...
<figure style="text-align:center; margin: 1.2rem 0;">
  ...
  <img src="figures/Efficiency/EmissionPrice.png" alt="Emission price effects" style="width:88%; max-width:980px; border-radius:6px;" />
</figure>

<figure style="text-align:center; margin: 1.2rem 0;">
  <figcaption><em>Figure 11. Emissions.</em></figcaption>
  <img src="figures/Efficiency/Emissions.png" alt="Emissions effects" style="width:88%; max-width:980px; border-radius:6px;" />
</figure>
