...
casParams = [{'Y0'; '=5'; 'initial GDP'; false; false; false; false; false} ...
             {'N0'; '=25/100'; 'initial sum of hours worked to potential hours worked'; false; false; true; false; false}...
             {'PE0'; '=0'; 'initial emiisons price level'; false; false; true; false; false}...
...
casParams = [{'beta'; '=9606/10000'; 'discount factor'; false; false; false; false; false} ...
             ...
             {'etaF'; '=6/10'; 'elasticity of substitution between imports and domestic products'; false; false; false; false; false}...
             {'etaX'; '=0.6'; 'supply price elasticity of exports'; false; false; false; false; false}...
             ...
             {'sE'; ['=0/(' num2str(inbsectors_p*inbregions_p*inbsubsectors_p + inbregions_p*inbsubsectors_p) ')']; 'share of emissions on total emissions for each sector'; false; true; true; false; false}...
             {'phiQI'; ['=1/' num2str(inbsectors_p)]; 'share of inputs from another sector for each subsector'; false; true; true; true; false}...
             {'sEI'; ['=0/(' num2str(inbsectors_p*inbregions_p*inbsubsectors_p + inbregions_p*inbsubsectors_p) ')']; 'share of emissions on total emissions for each sector using prdoucts from another sector as input'; false; true; true; true; false}...
