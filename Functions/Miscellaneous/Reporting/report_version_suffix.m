...
% appends via sSensitivity, e.g. '' -> ExcelFiles/Output/
% Baseline.csv and ExcelFiles/Model*5Sectorsand1Regions
% .xlsx. Mirrors the override logic in RunSimulations.m:
%
%   DGE_WORKBOOK_VERSION unset/empty  -> defaultSuffix ('')
