function strys = assign_exogenous_climate_and_prices(strys, strexo, strpar)
    %ASSIGN_EXOGENOUS_CLIMATE_AND_PRICES Assigns climate and price-related variables to strys.
%
% Inputs:
...
%   - strys  : updated structure with exogenous variables applied
    ...
    strys.rf = 1 / (strpar.beta_p * exp(strexo.exo_beta)) - 1 + strexo.exo_rf + strpar.deltaB_p;
