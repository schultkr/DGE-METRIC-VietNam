function [strys, strpar] = compute_regional_imports_and_demand(strys, strpar)
    %COMPUTE_REGIONAL_IMPORTS_AND_DEMAND Computes regional and sectoral imports, demand, and updates export shares.
%
% Inputs:
    ...
    for icoreg = 1:strpar.inbregions_p
        ...
        for icosec = 1:strpar.inbsectors_p
            ...
            for icosubsec = strpar.(['substart_' ssec '_p']):strpar.(['subend_' ssec '_p'])
                ...
                % phiM_F is calibrated as P_M*M_F / Q0_p (share of basic-price GO),
                % so the real quantity at calibrated prices is M_F = phiM_F * Q0_p / P_M.
                strys.(['M_F_' ssubsec '_' sreg]) = strpar.(['phiM_F_' ssubsec '_' sreg '_p']) * ...
                    strpar.Q0_p / strys.(['P_M_' ssubsec]);
                ...
                % phiM_I calibrated as P_M*M_I / Q0_p; real quantity = phiM_I * Q0_p / P_M.
