function [xstart_vec, strys, strpar] = build_initial_guess(strys, strexo, strpar, mode)
%BUILD_INITIAL_GUESS Constructs initial guess vector for the steady state solver.
%
% Inputs:
